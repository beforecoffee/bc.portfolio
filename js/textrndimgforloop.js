...
var imgLinks = [
    // format: ['imageSource','imageLinkURL'],
      ['images/pics/ceramics/Ceramics_1.JPG','art_ceramics.html'],
      ['images/pics/ceramics/Ceramics_2.JPG','art_ceramics.html'],
      ['images/pics/ceramics/Ceramics_3.JPG','art_ceramics.html'],
      ['images/pics/ceramics/Ceramics_4.JPG','art_ceramics.html'],
      ['images/pics/ceramics/Ceramics_5.JPG','art_ceramics.html'],
      ['images/pics/ceramics/Ceramics_6.JPG','art_ceramics.html'],
      ['images/pics/ceramics/Ceramics_7.JPG','art_ceramics.html'],
      ['images/pics/ceramics/Ceramics_8.JPG','art_ceramics.html'],
      ['images/pics/ceramics/Ceramics_9.JPG','art_ceramics.html'],
...
function addImgToArray() {
    ...
    for(i = 0; i < 9; i++){
        imageSource = 'images/pics/ceramics/Ceramics_' + i + '.JPG' ;
